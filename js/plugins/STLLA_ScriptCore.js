...
//   isJpg：是否為jpg
// ----------------------------------------------
ImageManager.loadBitmap = function(folder, filename, hue, smooth, isJpg) {
	if (filename) {
		if (isJpg) {
...
// ● 取得快取的Key(清快取比對用)
// ----------------------------------------------
ImageManager.getCacheKey = function(folder, filename) {
...
// ● 移除指定快取
// ----------------------------------------------
ImageManager.cacheRemove = function(key) {
