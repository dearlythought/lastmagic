...
//=============================================================================
 /*:
 * @plugindesc v1.00 Adiciona o mecanismo de batalha Taunt. Combatentes com
 * a propriedade taunt tornam-se o alvo do foco inimigo.
 ...
 * ============================================================================
 *
 * Taunt adiciona um novo mecanismo de batalha. Sempre que uma unidade tiver
 * um membro como uma marca de taunt, os ataques e habilidades de alvo Ãºnico
 * da unidade oposta vÃ£o focar na unidade que tiver taunt. Isso adiciona
 * controle aggro para qualquer unidade e pode adicionar um novo nÃ­vel de
 * profundidade para batalhas. Taunts sÃ£o divididas em fÃ­sicas, mÃ¡gicas, e
 * certas categorias, que respectivamente tornam-se o alvo de aÃ§Ãµes fÃ­sicas,
 * aÃ§Ãµes mÃ¡gicas, e certas aÃ§Ãµes.
 *
 * Se houver mÃºltiplos usuÃ¡rios com taunt, a party rival pode escolher qual
 * usuÃ¡rio com taunt atacar. Isso Ã© para prevenir um lockdown causado por uma
 * unidade rival fazendo a batalha impossÃ­vel de progredir.
 *
 * ============================================================================
 * Notetags
 * ============================================================================
 *
 * Aqui estÃ£o alguns notetags que vocÃª pode usar para adicionar marcas de taunt
 * para seus vÃ¡rios objetos do banco de dados.
 *
 * Notetags de Personagem, Classe, Arma, Armadura, Estado, Inimigo:
 *   <Physical Taunt>
 *   <Magical Taunt>
 *   <Certain Taunt>
 *   Esses trÃªs notetags habilitam o objeto escolhido do banco de dados a ter
 *   o respectivo mecanismo de taunt contra aqueles tipos de aÃ§Ãµes. Taunts
 *   fÃ­sicos irÃ£o causar ao usuÃ¡rio a aggro todos os tipos de aÃ§Ãµes fÃ­sicas do
 *   time rival. O mesmo serve para taunts mÃ¡gicos e certos taunts de sua
 *   natureza.
 *
 *   <Null Physical Taunt>
 *   <Null Magical Taunt>
 *   <Null Certain Taunt>
 *   Isso anula a respectiva marca de taunt no usuÃ¡rio (nÃ£o o atacante). Isso
 *   quer dizer que se um usuÃ¡rio originalmente tem taunt de alguma forma, ter
 *   uma marca de taunt anulada aplicada irÃ¡ remover aquele efeito de taunt e
 *   o usuÃ¡rio irÃ¡ ser tratado como um alvo normal.
 *
 *   <Ignore Physical Taunt>
 *   <Ignore Magical Taunt>
 *   <Ignore Certain Taunt>
 *   Isso permite um atacante com essa marca a ignorar qualquer taunts de sua
 *   respectiva natureza e ganhar acesso a todos os alvos possÃ­veis como se
 *   nÃ£o houvesse taunts no lugar.
 *
 * Skill and Item Notetag:
 *   <Bypass Taunt>
 *   Isso causa essa habilidade/item a ignorar taunts como um todo e a
 *   habilidade/item Ã© capaz de selecionar alvos Ãºnicos como se nenhum taunt
 *   existisse no campo de batalha.
 */
//=============================================================================
